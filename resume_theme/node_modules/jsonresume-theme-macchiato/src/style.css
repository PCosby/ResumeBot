...
.page {
  background: white;
  width: calc(100% - 15px);   /* full-width minus 5px on left & right */
  min-height: 792px;
  display: block;
  margin: 0 auto;
  border-top: 10px solid #26638d;
  padding: 5px 5px;           /* keep your tighter internal padding */
...
/* ------ Tighter Education Section ------ */

.education-container {
  padding-top: 8px;   /* was 20px */
}

.education-container .item {
  margin-bottom: 6px; /* was 15px */
}

.education-container .location {
  padding-bottom: 2px; /* was 6px */
}
...
.education-container ul {
  margin-top: 4px;    /* shrink course-list spacing if used */
}


/* ------- Tighter spacing between Experience and Projects ------- */

/* Reduce top padding of Projects container */
.project-container {
  padding-top: 2px;    /* or 0 if you want them to really touch */
}
...
/* Slightly increase readability across the board */
p, li {
  font-size: 12px;
}
...
.info-tag-container a {
  color: #26638d;                        /* your accent color */
  text-decoration: underline;            /* clear clickable cue */
  text-underline-offset: 2px;            /* cleaner spacing */
